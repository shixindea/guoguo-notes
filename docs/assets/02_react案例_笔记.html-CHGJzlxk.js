import{_ as a,c as t,a as n,o as r}from"./app-B46g4QSv.js";const s={};function c(p,e){return r(),t("div",null,e[0]||(e[0]=[n(`<h1 id="_1-使用react脚手架创建一个react应用" tabindex="-1"><a class="header-anchor" href="#_1-使用react脚手架创建一个react应用"><span>1. 使用React脚手架创建一个React应用</span></a></h1><h2 id="_1-react脚手架" tabindex="-1"><a class="header-anchor" href="#_1-react脚手架"><span>1). react脚手架</span></a></h2><pre><code>1. xxx脚手架: 用来帮助程序员快速创建一个基于xxx库的模板项目
	* 包含了所有需要的配置
	* 指定好了所有的依赖
	* 可以直接安装/编译/运行一个简单效果
