import{_ as r,c as t,a as n,o as a}from"./app-B-udnfPz.js";const d={};function c(u,e){return a(),t("div",null,e[0]||(e[0]=[n(`<h1 id="_0-redux要点" tabindex="-1"><a class="header-anchor" href="#_0-redux要点"><span>0. redux要点</span></a></h1><pre><code>1. redux理解
2. redux相关API
3. redux核心概念(3个)
4. redux工作流程
5. 使用redux及相关库编码
