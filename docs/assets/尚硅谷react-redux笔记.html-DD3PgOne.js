import{_ as e,c as r,a as n,o as a}from"./app-D39qd1p7.js";const c={};function d(o,t){return a(),r("div",null,t[0]||(t[0]=[n(`<h2 id="_1-求和案例-redux精简版" tabindex="-1"><a class="header-anchor" href="#_1-求和案例-redux精简版"><span>1.求和案例_redux精简版</span></a></h2><pre><code>	(1).去除Count组件自身的状态
	(2).src下建立:
					-redux
						-store.js
						-count_reducer.js
