...
<span class="line"></span>
<span class="line"><span class="token string">"lint"</span><span class="token builtin class-name">:</span> <span class="token string">"git add . &amp;&amp; pretty-quick --staged &amp;&amp; git add . "</span>,</span>
...
<p>pnpm i prettier     ===&gt;    &quot;lint:fix&quot;: &quot;prettier --write .&quot;,       // 适用于新接手的 项目初始化</p>
<p>​    &quot;lint&quot;: &quot;pretty-quick --staged&quot;,</p>
<p>​    &quot;lint:fix&quot;: &quot;prettier --write .&quot;,</p>
</blockquote>
<blockquote>
<p>添加配置</p>
</blockquote>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote>
<h2 id="项目根目录-editorconfig" tabindex="-1"><a class="header-anchor" href="#项目根目录-editorconfig"><span>项目根目录 .editorconfig</span></a></h2>
<blockquote>
<p>.editorconfig 通常用于统一代码风格，以便在不同的开发环境和编辑器中保持一致的格式。</p>
</blockquote>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token punctuation">[</span><span class="token operator">*</span><span class="token punctuation">.</span><span class="token punctuation">{</span>js<span class="token punctuation">,</span>jsx<span class="token punctuation">,</span>ts<span class="token punctuation">,</span>tsx<span class="token punctuation">,</span>vue<span class="token punctuation">}</span><span class="token punctuation">]</span></span>
...
<span class="line">max_line_length <span class="token operator">=</span> <span class="token number">100</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="生成日志" tabindex="-1"><a class="header-anchor" href="#生成日志"><span>生成日志</span></a></h2>
