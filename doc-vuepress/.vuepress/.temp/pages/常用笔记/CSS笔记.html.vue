...
<hr>
<h2 id="单行省略" tabindex="-1"><a class="header-anchor" href="#单行省略"><span>单行省略</span></a></h2>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="两行省略" tabindex="-1"><a class="header-anchor" href="#两行省略"><span>两行省略</span></a></h2>
...
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre class="language-css"><code><span class="line"><span class="token selector">.over-line</span> <span class="token punctuation">{</span></span>
