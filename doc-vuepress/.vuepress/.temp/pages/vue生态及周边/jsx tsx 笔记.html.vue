...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">pnpm install @vitejs/plugin-vue-jsx -D</span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">import { defineConfig } from "vite";</span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">&lt;template></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">import { defineComponent } from 'vue';</span>
<span class="line"></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">return () => (</span>
<span class="line">  &lt;></span>
<span class="line">    &lt;div>Child1&lt;/div></span>
<span class="line">    &lt;div>Child2&lt;/div></span>
<span class="line">    &lt;div>Child3&lt;/div></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">// SFC</span>
<span class="line">&lt;template></span>
<span class="line">  &lt;div></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">// SFC child</span>
<span class="line">&lt;template></span>
<span class="line">  &lt;div></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">// parent name和click都不在子组件的明确接收中</span>
...
<p>我们看一个简单的例子：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">&lt;div class="item">样式示例&lt;/div></span>
<span class="line"></span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">.child-item {</span>
<span class="line">  background-color: pink;</span>
<span class="line">}</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">// TSX child.tsx</span>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">css: {</span>
